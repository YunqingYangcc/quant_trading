...
UNIVERSE = {
    ...
    "material": [
        ...
        ("002129.SZ", "TCL中环"),
        ("300666.SZ", "江丰电子"), ("603690.SH", "至纯科技"),
        ("688596.SH", "正帆科技"), ("688106.SH", "金宏气体"),
        ("300316.SZ", "晶盛机电"), ("688126.SH", "沪硅产业"),
    ],
    "ai-power": [
        ...
        ("002518.SZ", "科士达"), ("603912.SH", "佳力图"),
        ("300286.SZ", "安科瑞"), ("300693.SZ", "盛弘股份"),
        ("600995.SH", "南网储能"),
    ],
}
